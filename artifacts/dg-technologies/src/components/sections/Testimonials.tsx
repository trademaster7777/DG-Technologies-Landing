        ...
        >
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <p className="text-lg text-foreground/95 leading-relaxed mb-8 relative z-10">
                "{t.quote}"
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary/30 to-accent/30 border border-foreground/10 flex items-center justify-center text-foreground/80 font-semibold text-sm">
                  {t.initials}
                </div>
                <div>
